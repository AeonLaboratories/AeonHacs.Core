...
namespace AeonHacs.Components
{
    ...
    public class SolenoidValve : ManagedSwitch, ISolenoidValve, SolenoidValve.IDevice, SolenoidValve.IConfig
    {
        ...
        object PendingOperationsLocker = new object();
        ...
        public override OnOffState OnOffState
        {
            ...
            protected set
            {
                if (!Idle)
                {
                    ...
                    WaitFor(() => MillisecondsInState >= MillisecondsToChangeState, MillisecondsToChangeState, 10);
                    operationStopping();
                    InMotion = false;
                }
        ...
        void operationStarting() { lock (PendingOperationsLocker) PendingOperations++; }
        void operationStopping() { lock (PendingOperationsLocker) if (PendingOperations > 0) PendingOperations--; }
