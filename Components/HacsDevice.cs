...
namespace AeonHacs.Components
{
    ...
    public class HacsDevice : HacsComponent, IHacsDevice, HacsDevice.IDevice, HacsDevice.IConfig
    {
        ...
        /// <summary>
        /// These event handlers are invoked whenever the device's target
        ...
        public virtual void NotifyConfigChanged([CallerMemberName] string propertyName = default) =>
            NotifyConfigChanged(this, PropertyChangedEventArgs(propertyName));
        ...
        object UpdatesReceivedLocker = new object();
        ...
        {
            get => updatesReceived;
            protected set { lock (UpdatesReceivedLocker) Ensure(ref updatesReceived, value); }
        }
