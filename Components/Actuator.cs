...
namespace AeonHacs.Components
{
    public class Actuator : ManagedDevice, IActuator, Actuator.IDevice, Actuator.IConfig
    {
        ...
        public virtual bool OperationFailed
        {
            get => operationFailed;
            set => Ensure(ref operationFailed, value);
        }
        bool operationFailed;

        protected virtual void OperationEnding()
        {
            ActionSucceeded = ReviewOperation();
            lock (PendingOperationsLocker) PendingOperations--;
        }

        protected virtual bool ReviewOperation() => !OperationFailed;
