...
public interface IMeter : IHacsDevice, IDoubleUpdatable
{
    ...
    double RawValue { get; }
    double FilteredValue { get; }
    double PriorValue { get; }
    double ConvertedValue { get; }
    double ResolvedValue { get; }
...
public interface IDualManometer : ISwitchedManometer, IManualMode
{
    ...
    IManometer LowPressureManometer { get; set; }
    /// <summary>
...
/// Supports HC6-C
/// </summary>
public interface IHC6Controller : ISerialDeviceManager
{
    new HC6Controller.IDevice Device { get; }
    new HC6Controller.IConfig Config { get; }
    string Model { get; }
    string Firmware { get; }
    int SerialNumber { get; }
...
/// <summary>
/// Supports the obsolete HC6-B2
/// </summary>
public interface IHC6ControllerB2 : IHC6Controller
{
...
public interface IHC6Heater : IManagedHeater
{
    new HC6Heater.IDevice Device { get; }
    new HC6Heater.IConfig Config { get; }

    int ThermocoupleChannel { get; set; }
    IPidSetup Pid { get; set; }
    HC6Heater.Modes Mode { get; }
    HC6Thermocouple Thermocouple { get; }
    int PidGain { get; }
    int PidIntegral { get; }
...
public interface IHC6Thermocouple : IManagedThermocouple
{
    new HC6Thermocouple.IDevice Device { get; }
    new HC6Thermocouple.IConfig Config { get; }
...
public interface ISection : IChamber
{
    ...
    void WaitForTemperatureAbove(double temperature);

    /// <summary>
    /// Wait until the temperature is less than the specified value.
    /// </summary>
    /// <param name="temperature"></param>
    void WaitForTemperatureBelow(double temperature);
...
public interface IVacuumSystem : IHacsComponent
{
    ...
    /// <summary>
    /// Wait until the VM pressure has remained below the specified value
    /// and the Foreline pressure has remained stable for the specified duration.
    /// </summary>
    /// <param name="pressure">The desired pressure</param>
    /// <param name="seconds">minimum time conditions must remain satisfied</param>
    void WaitForStablePressure(double pressure, int seconds = 5);
...
{
    CegsPreferences CegsPreferences { get; set; }
