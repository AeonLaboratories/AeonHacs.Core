...
namespace AeonHacs.Components
{
    ...
    public class RS232Valve : CpwValve, IRS232Valve, RS232Valve.IDevice, RS232Valve.IConfig
    {
        ...
        {
            if (OperationFailed || Errors != ActuatorController.ErrorCodes.None) return false;
            if (Operation == null) return true;
            if (UpdatesReceived <= 0 || RS232UpdatesReceived <= 0) return false;
        ...
        public void Calibrate()
        {
            ...
            operationName = "_CalibrationMovement";   // temporary
